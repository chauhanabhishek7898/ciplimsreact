...
import { AdditionalIn_Insert, GetPODetailsLIkeSearch } from './AdditionalInService'
                    ...
                    buttons: [
                        {
                            ...
                            onClick: () => {
                                ...
                                AdditionalIn_Insert(GRNOrder, vPOFilePath).then(res => {
                                    if (res) {
                                        setLoader(false)
                                        toast.success("Record Added Successfully !!")
                                        navigate('/AdditionalIn')
...
export default AddAdditionalIn