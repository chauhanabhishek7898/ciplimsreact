...
import { ProductionDetails_Insert, GetPODetailsLIkeSearch, GetExpDateForRejection, GetBalStockForRejection, GetMRDOCDetailsLIkeSearch } from './ProductionDetailsService'
        ...
        buttons: [
          {
            ...
            onClick: () => {
              ...
              ProductionDetails_Insert(data).then(res => {
                if (res) {
                  setLoader(false)
...
export default AddProductionDetails